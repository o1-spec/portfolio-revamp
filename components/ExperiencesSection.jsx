      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            <span className="text-gray-400 text-[15px] font-medium tracking-wider uppercase">
              Career Journey
            </span>
          </motion.div>

          <h2 className="text-3xl md:text-3xl lg:text-5xl font-bold text-white mb-4 tracking-tight">
            Professional
            <br />
          ...
          <motion.p
            className="text-gray-400 text-lg md:text-[17px] max-w-3xl mx-auto leading-relaxed"
        ...
        <div className="flex flex-col lg:flex-row gap-12 pt-6">
            ...
            <div className="space-y-4">
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <div className="opacity-75 text-[15px]">{exp.role}</div>
                  <div className="text-[15px] opacity-60 mt-1">
                    {exp.duration}
                  </div>
                </motion.button>
              ))}
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                ...
                <div className="mt-4 md:mt-0">
                  <div className="inline-block p-[1px] rounded-full bg-gradient-to-r from-purple-500 to-pink-500">
                    <span className="block px-3 py-1 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-[13px] rounded-full">
              ...
              {/* Description */}
              <p className="text-gray-300 leading-relaxed mb-6 text-[16px]">
              ...
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                  <Award className="w-5 h-5 text-purple-400 text-[16px]" />
                  Key Achievements
                </h4>
              ...
              {/* Technologies */}
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-white mb-2.5 flex items-center gap-2">
                  <Code className="w-5 h-5 text-blue-400 text-[16px]" />
                  Technologies Used
                </h4>
                <div className="flex flex-wrap gap-2">
                  {experiences[selectedExperience].technologies.map(
                    (tech, index) => (
                      <motion.span
                        key={tech}
                        className="px-2 py-1 text-[15px] text-gray-300 text-sm rounded-full border border-gray-700 hover:border-purple-500/50 transition-colors"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {experiences[selectedExperience].projects.map(
                  (project, index) => (
                    ...
                    >
                      <h5 className="font-semibold text-white mb-2 text-[16px]">
                        {project.name}
                      </h5>
